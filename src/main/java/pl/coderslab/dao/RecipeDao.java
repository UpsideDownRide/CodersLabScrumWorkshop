...
public class RecipeDao {
    ...
    private static final String READ_RECIPE_DETAILS_BY_ADMIN_ID_QUERY = "select recipe.id,name,ingredients,description,created,updated,preparation_time,preparation from recipe join admins a on a.id = recipe.admin_id where admin_id =?";
